...
{
    public class  Edi856PHeaderRecord : Edi856HeaderRecord
    {
        ...
        // 02-06-2022 begin
        private List<Edi856PalletRecord> _details = new List<Edi856PalletRecord>();
        public List<Edi856PalletRecord> Details
        {
            get
            {
                return _details;
