...
namespace Infocus.Common.Collections
{
        ...
        INotifyPropertyChanged
    {
        ...
        protected class KeyedDictionaryEntryCollection<TKey2> : KeyedCollection<TKey2, DictionaryEntry>
        {
            #region constructors
            ...
            public KeyedDictionaryEntryCollection(IEqualityComparer<TKey2> comparer) : base(comparer) { }
            ...
            protected override TKey2 GetKeyForItem(DictionaryEntry entry)
            {
                return (TKey2)entry.Key;
            }
        ...
        public struct Enumerator<TKey2, TValue2> : IEnumerator<KeyValuePair<TKey2, TValue2>>, IDisposable, IDictionaryEnumerator, IEnumerator
        {
            #region constructors

            internal Enumerator(ObservableDictionary<TKey2, TValue2> dictionary, bool isDictionaryEntryEnumerator)
            {
                _dictionary = dictionary;
                _version = dictionary._version;
                _index = -1;
                _isDictionaryEntryEnumerator = isDictionaryEntryEnumerator;
                _current = new KeyValuePair<TKey2, TValue2>();
            }
            ...
            public bool MoveNext()
            {
                ...
                {
                    _current = new KeyValuePair<TKey2, TValue2>((TKey2)_dictionary._keyedEntryCollection[_index].Key, (TValue2)_dictionary._keyedEntryCollection[_index].Value);
                    return true;
                }
                _index = -2;
                _current = new KeyValuePair<TKey2, TValue2>();
            ...
            object IEnumerator.Current
            {
                get
                {
                    ...
                    return new KeyValuePair<TKey2, TValue2>(_current.Key, _current.Value);
                }
            }
            ...
            private ObservableDictionary<TKey2, TValue2> _dictionary;
            private int _version;
            private int _index;
            private KeyValuePair<TKey2, TValue2> _current;
